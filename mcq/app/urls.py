...
from . import views
from . views import (CategoriesView,QuestionsView, PurchasesQuestionSets,
                     SliderListAPIview,PurchaseCreateAPIView, ExamList,
                     ScoreCreateAPIView, PaymentPatnerList,FreeQuestionList)
...
urlpatterns = [
    ...
    path('question_sets/purchase/create', PurchaseCreateAPIView.as_view(), name='purchase_question_set'), # purchase question sets
    path('exam',ExamList.as_view(), name ='examlist'), #Free and Purchase question sets
