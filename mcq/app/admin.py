...
from . models import Categories, QuestionSets,Questions, Answer,Purchases,Slider,Score,PaymentPatner
...
class QuestionSetsAdmin(admin.ModelAdmin):
    model = QuestionSets
    list_display =['id','set_name','categorie','is_free','order_number']
